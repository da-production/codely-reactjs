...
function Footer() {
    return ( <> 
    <footer className="font-sans relative mt-16 pb-3 md:pb-6 z-10">
        <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center text-center">
                <div className="flex w-full justify-center text-center">
                    <div className="text-2xl px-4">
                        <h3 className="font-bold text-gray-800 dark:text-gray-100">
                            Codely<span className='text-[#FF7F50]'>.</span>
                        </h3>
                        ...
                        <div className="flex-row my-4">
                            <a
                                ...
                                href="mailto:ahampriyanshu@gmail.com?subject = Greeting&body = Hi there"
                                type="button">
                                <svg
                                    width={24}
                                    height={24}
                        ...
                        <div className="text-sm text-gray-700 dark:text-gray-400 py-1">
                            ©<span id="year">2024</span>&nbsp;
                            <a
                                href="javascript:void(0)"
                                className="hover:underline dark:hover:text-gray-300 hover:text-gray-800">
                                Mebrouki Amine
                            </a>
                            .
                        </div>
